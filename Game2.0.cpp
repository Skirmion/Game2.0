...
void Game::update()
{
	...
	if (shot1 and (direction1[0] != 0 or direction1[1] != 0) and sleepgun1 < 0) { pos1 = myPlayer1.getPosition(); spheres1[i] = { {pos1.x + myPlayer1.getRadius(), pos1.y + myPlayer1.getRadius()} , {float(180 * direction1[0]), float(180 * direction1[1])},  {0, 0}, 10, 255, 0, 0, 10 }; i += 1; sleepgun1 = 20; };
	...
	if (shot2 and (direction2[0] != 0 or direction2[1] != 0) and sleepgun2 < 0) { pos2 = myPlayer2.getPosition(); spheres2[g] = { {pos2.x + myPlayer2.getRadius(), pos2.y + myPlayer2.getRadius()} , {float(180 * direction2[0]), float(180 * direction2[1])},  {0, 0}, 10, 0, 0, 255, 10 }; g += 1; sleepgun2 = 20; };
	if (g == numberbullet) g = 0;

	sleepgun1 -= 1; sleepgun2 -= 1;
...
void Game::render()
{
	...
	health(pos1.x, pos1.y, health1, 0);
	health(pos2.x, pos2.y, health2, 1);
...
void Game::health(int x, int y, int health, int player)
{
